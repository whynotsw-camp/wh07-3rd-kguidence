...
{/*Welcome! We are K-Guidance, a dedicated travel platform for foreign visitors.
                    ...
                    <section className="concept-selection">
                        <h3 className="concept-prompt fade-in-text fade-in-delay-4"> Please decide the concept ✔</h3>
                        ...
                        <ConceptCard 
                                ...
                                >
                                    ...
                                    <div className="card-description">
                                        <p>
                                                Hi there! I'm a <strong>K-pop Demon Hunters</strong>-themed chatbot<br />
                                                here to introduce you to <strong>Korea's diverse attractions and charms</strong>!
                                                I'll show you famous Korean spots where traces of hidden demons might still linger.<br />
                                                Ready to embark on a Korean adventure with me right now?
                                        </p>                        
                                    </div>
                                </ConceptCard>
                            ...
                            <ConceptCard 
                                ...
                                >
                                             <div className="card-description">
                                        <p>
                                            K-Pop 아이돌이 되어 화려한 무대와 치열한 전투를 동시에 경험하는 액션 RPG 컨셉입니다.
                                        </p>
                                    </div>
                                </ConceptCard>
